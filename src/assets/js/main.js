...
document.addEventListener("DOMContentLoaded", () => {
    ...
    menuLinkContainers.forEach((link) => {
        link.addEventListener("mouseenter", () => {
            ...
            const animatedChars = animateCopy.querySelectorAll(".char");
    ...
    menuOverlay.addEventListener("mousemove", (e) => {
        ...
        if (mouseX <= startX) {
            ...
            mousePersentage = (mouseX - startX) / sensitivityRange;
        }

        targetX = maxMoveLeft + mousePersentage * (maxMoveRight - maxMoveLeft);
    });
